...
y_s <- sim_single(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 5, b = 3)

y_m <- sim_single(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 2, b = 2)
y_n <- sim_single(seed = seed_exp, n1 = N_tot, n2 = 2, n3 = 2, a = 2, b = 2)[1:N_tot, ]

y_l <- sim_single(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 1, b = 1)
...
res_single <- list(clusters_n = clusters_n, clusters_s = clusters_s, clusters_m = clusters_m, clusters_l = clusters_l)

setwd("/results")  ##--save the results to folder
file_name <- paste("res_single_large_", seed_exp, ".RData", sep = "")
save(res_single, file = file_name)
