...
y_m <- sim_single(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 3, b = 1)
y_n <- sim_single(seed = seed_exp, n1 = N_tot, n2 = 2, n3 = 2, a = 3, b = 1)[1:N_tot, ]
...
file_name <- paste("res_single_small_", seed_exp, ".RData", sep = "")
