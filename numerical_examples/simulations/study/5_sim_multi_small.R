...
y_s <- sim_multi(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 6, b = 6)

y_m <- sim_multi(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 3, b = 3)
y_n <- sim_multi(seed = seed_exp, n1 = N_tot, n2 = 2, n3 = 2, a = 3, b = 3)[1:N_tot, ]

y_l <- sim_multi(seed = seed_exp, n1 = n1, n2 = n2, n3 = n3, a = 1, b = 1)
...
res_multi <- list(clusters_n = clusters_n, clusters_s = clusters_s, clusters_m = clusters_m, clusters_l = clusters_l)

setwd("/results")  ##--save the results to folder
file_name <- paste("res_multi_small_", seed_exp, ".RData", sep = "")
save(res_multi, file = file_name)
